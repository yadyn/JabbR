...
(function () {
    ...
    emotelistTabs.append(
        $('<ul/>')
            ...
            .append($('<li/>')
                .append($('<a/>').attr('href', '#emotelisttab-10').attr('title', 'animu').text('m')))
            .append($('<li/>')
                .append($('<a/>').attr('href', '#emotelisttab-11').attr('title', 'animu').text('n')))
            .append($('<li/>')
                .append($('<a/>').attr('href', '#emotelisttab-12').attr('title', 'animu').text('o')))
            .append($('<li/>')
                .append($('<a/>').attr('href', '#emotelisttab-13').attr('title', 'animu').text('p')))
            .append($('<li/>')
                .append($('<a/>').attr('href', '#emotelisttab-14').attr('title', 'v4c').text('v')))
            .append($('<li/>')
                .append($('<a/>').attr('href', '#emotelisttab-15').attr('title', 'yukkuri').text('y'))))

    var colCount = { 'a': 0, 'b': 0, 'c': 0, 'd': 0, 'e': 0, 'f': 0, 'g': 0, 'h': 0, 'j': 0, 'm': 0, 'n': 0, 'o': 0, 'p': 0, 'v': 0, 'y': 0 };
    var rows = { 'a': [], 'b': [], 'c': [], 'd': [], 'e': [], 'f': [], 'g': [], 'h': [], 'j': [], 'm': [], 'n': [], 'o': [], 'p': [], 'v': [], 'y': [] };
    ...
    emotelistTabs.append(
        $('<div/>').attr('id', 'emotelisttab-10').append($('<table/>').append(rows['m'].join(''))));
    emotelistTabs.append(
        $('<div/>').attr('id', 'emotelisttab-11').append($('<table/>').append(rows['n'].join(''))));
    emotelistTabs.append(
        $('<div/>').attr('id', 'emotelisttab-12').append($('<table/>').append(rows['o'].join(''))));
    emotelistTabs.append(
        $('<div/>').attr('id', 'emotelisttab-13').append($('<table/>').append(rows['p'].join(''))));
    emotelistTabs.append(
        $('<div/>').attr('id', 'emotelisttab-14').append($('<table/>').append(rows['v'].join(''))));
    emotelistTabs.append(
        $('<div/>').attr('id', 'emotelisttab-15').append($('<table/>').append(rows['y'].join(''))));
