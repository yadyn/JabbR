...
(function ($, window) {
    ...
    emotelistTabs.append(
        $('<div/>').attr('id', 'emotelisttab-4').append($('<table/>').append(rows['e'].join(''))));
    emotelistTabs.append(
        $('<div/>').attr('id', 'emotelisttab-5').append($('<table/>').append(rows['j'].join(''))));
    emotelistTabs.append(
        $('<div/>').attr('id', 'emotelisttab-6').append($('<table/>').append(rows['v'].join(''))));
